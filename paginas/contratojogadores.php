...
if(isset($_POST['submit'])){
    ...
    $sql_contrato = "INSERT INTO contratojogadores(id,idClube,idJogador,inicioContrato,fimContrato) VALUES('','$clube','$jogador','$icon','$fcon')";
                    ...
                    <tbody id="corpoTable">
                        <?php foreach ($result3 as $reg3) : ?>
                            <tr>
                                <td><?= $reg3['jogador']; ?></td>
                                <td><?= $reg3['clube']; ?></td>
                                <td><?= $reg3['inicioContrato']; ?></td>
                                <td><?= $reg3['fimContrato']; ?></td>

                                <td>
                                    <a href="editar/editarContratoJogadores.php?id=<?= $reg3['id']; ?>" class="btn btn-warning">EDITAR / DELETAR</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
