...
$idj = filter_input(INPUT_GET, 'idTecnico');
if ($idj) {
    $sql = "SELECT * 
            FROM tecnicos   
            WHERE idTecnico = $idj";
...
$sql_jogador = "SELECT * FROM tecnicos WHERE idTecnico = $idj";
...
if (isset($_POST['submit'])) {
    ...
    $SQLdados = "UPDATE tecnicos SET nome = '$nome' WHERE idTecnico = $idj";
...
if (isset($_POST['editarImagem'])) {
    ...
    $sql_foto = "UPDATE tecnicos SET fotoPerfil = '$novo_nome' WHERE idTecnico = $idj";
...
if (isset($_POST['submita'])) {
    $sql_delete = "DELETE FROM contratotecnicos WHERE idTecnico = $idj";
    $res_delete = $conn->query($sql_delete);
    $res_delete->execute();

    $sql_delJogador = "DELETE FROM tecnicos WHERE idTecnico = $idj";
...
<head>
    ...
    <title>Editar Técnicos | TwoFootball</title>
    <link rel="stylesheet" href="styles/editarTecnico.css">
...
<nav style="margin-top: 0px;" id="menu" class="menu" onmouseenter="abrir()" onmouseleave="abrir()">
    ...
    <div id="formulario">
        <form action="" method="post">
            ...
            <label for="fotoPerfil" style="margin-top: 5px; margin-bottom: 5px;">Foto:<strong>*</strong></label>

            <p id="abrirEditarFoto" onclick="abrirEditarFoto()" style="margin-bottom: 5px;" style="cursor: pointer;">Clique aqui para editar a foto*</p>
            ...
            <?php
            if ($login) {
                echo ' <input id="adicionar" type="submit" value="EDITAR TÉCNICO" name="submit" style="margin-top: 5px;">
                <input id="adicionar" type="submit" value="APAGAR TÉCNICO" name="submita" style="margin-top: 5px;">';
            } else {
                echo ' <input id="adicionar" type="submit" value="EDITAR TÉCNICO" name="submit" style="margin-top: 5px;" disabled>
                <input id="adicionar" type="submit" value="APAGAR TÉCNICO" name="submita" style="margin-top: 5px;" disabled>';
            }
            ?>
    ...
    <div id="editarFoto">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <img src="../../usuario/uploads/x.png"width="30px"style="margin-left: 50px; height: 30px; margin-bottom: -5px; cursor: pointer;" onclick="fecharEditarFoto()">
