...
$sql = "SELECT * FROM localizacao ORDER BY localizacao.nome;";
$result = $conn->query($sql);

$sql2 = "SELECT clubes.idClube, clubes.nome, clubes.dataFundacao, localizacao.nome AS localizacao, clubes.logo FROM clubes JOIN localizacao ON localizacao.idLocalizacao = clubes.idLocalizacao ORDER BY clubes.nome ASC;";
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['fotoPerfil'])) {
        ...
        $sql_jogador = "INSERT INTO clubes(idClube,nome,dataFundacao,idLocalizacao,logo) VALUES('','$nome','$dataFundacao','$localizacao','$novo_nome')";
...
<head>
    ...
    <title>Clubes | TwoFootball</title>
    <link rel="stylesheet" href="styles/clube.css">
...
<body>
    ...
    <div class="row">
        <div class="col-md-6" id="adicionarClube">
            <form action="" method="post" enctype="multipart/form-data">

                <label for="nome" style="padding-top: 10px;">
                    <p class="paragrafo">Nome:<strong>*</strong></p>
                </label>
                <input class="cxdt" type="text" placeholder=" Ex: Real Madrid" name="nome" required />
                ...
                <label for="fotoPerfil">Logo:<strong>*</strong></label>
        ...
        <div class="col-md-6" id="tabelaClube">
                    ...
                    <tbody id="corpoTable">
                        <?php foreach ($result2 as $reg2) : ?>
                            <tr>
                                ...
                                <td><img src="../imagens/FotosClube/<?= $reg2['logo']; ?>" width="50px"></td>

                                <td>

                                    <a href="editar/editarClube.php?idClube=<?= $reg2['idClube']; ?>" class="btn btn-warning">EDITAR / DELETAR</a>
            ...
            <img src="../imagens/logo.png" width="300px" style="margin: 20px 0px 0px 140px;">
        </div>
    </div>
